	<footer >
		<div class="footer-area pt-4 pb-4 bg-dark text-white ">
			<div class="container">
				<div class="row ">

					<div class="col-lg-4 col-sm-6">
	                    <div class="single-footer-widget ps-3">
	                        <a class="navbar-brand " fla href="#"><img src="<?php echo base_url(); ?>bootstrap/img/Harmonia_Text_White.png" alt="Harmonia Inmobiliaria" style="max-width: 250px; max-height: 60px;"></a>
					...
					<div class="col-lg-4 col-sm-6 ">
	                    <div class="single-footer-widget">
	                        ...
	                        <ul class="info-list">
	                            ...
	                            <li>
	                                <span>Telefono:</span>
	                                <a href="tel:0258546438383">+(025) 8546-438383</a>
	                            </li>
